...
```{r}
myfiles = list.files(path = here::here("TvA_curves_analysis_data/Midline_Data"), pattern = "1000_radii", full.names = TRUE)
...
```{r}
myfiles = list.files(path = here::here("TvA_curves_analysis_data/Midline_Data"), pattern = "1500_radii", full.names = TRUE)
...
```{r}
myfiles = list.files(path = here::here("TvA_curves_analysis_data/Midline_Data"), pattern = "2000_radii", full.names = TRUE)

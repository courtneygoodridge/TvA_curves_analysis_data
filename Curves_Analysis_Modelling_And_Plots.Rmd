...
## Figure 3: Reaction time predictions

```{r}
acc.rt <- read.csv(here::here("TvA_curves_analysis_data/Prediction_Data/accumulator.steering.preds.radii.RT.csv")) 
thresh.rt <- read.csv(here::here("TvA_curves_analysis_data/Prediction_Data/threshold.steering.preds.radii.RT.csv")) 
...
ggsave(here::here("TvA_curves_analysis_data/Plots/Fig3.tiff"), g,  width = 10, height = 7, units = 'cm', dpi = 600, type = 'cairo')
```

## Figure 4: Lateral position error predictions and data
...
## Figure 5: Steering rate predictions and data
...
## Figure 7: Bird's eye view of experimental conditions
...
ggsave(here::here("TvA_curves_analysis_data/Plots/Fig7.tiff"), plot = last_plot(), width = 10, height = 7, units = 'cm', dpi = 600, type = 'cairo')
```

## Figure 8: Average trajectories for each condition
...
ggplot() +
  ...
  ggsave(here::here("TvA_curves_analysis_data/Plots/Fig8.tiff"), plot = last_plot(), width = 15, height = 10, units = 'cm', dpi = 600, type = 'cairo')
```

## Figure 9: reaction time results 
...
ggsave(here::here("TvA_curves_analysis_data/Plots/Fig9.tiff"), g,  width = 15, height = 7, units = 'cm', dpi = 600, type = 'cairo')
```

## Figure 10: lateral position error results
...
"latency"
latency.coords <- read.csv(here::here("TvA_curves_analysis_data/Participant_Data/latency_coords.csv")) 
```

## Figure 11: steering rate

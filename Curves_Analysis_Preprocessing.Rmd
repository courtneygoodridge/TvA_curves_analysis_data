...
Following this, run each chunk of code individually. The main data file (overall.dat.csv) is alreayd processed and is generated from this script. I only include this file for completeness. The main analysis and figure plotting can done from the Curves_Analysis_Modelling_And_Plots.Rmd.
...
write.csv(total.trials, file = here::here("TvA_curves_analysis_data/Participant_Data/total_trials.csv"))
```
